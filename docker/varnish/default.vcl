...
backend localhost { # Define one backend
...
backend server1 { # Define one backend
  .host = "172.17.0.3";    # IP or Hostname of backend
  .port = "8000";           # Port Apache or whatever is listening
  .max_connections = 300; # That's it
  .probe = {
    #.url = "/"; # short easy way (GET /)
...
backend server2 { # Define one backend
  .host = "172.17.0.4";    # IP or Hostname of backend
  .port = "8000";           # Port Apache or whatever is listening
  .max_connections = 300; # That's it
  .probe = {
    #.url = "/"; # short easy way (GET /)
...
backend server3 { # Define one backend
  .host = "172.19.0.4";    # IP or Hostname of backend
  .port = "8000";           # Port Apache or whatever is listening
  .max_connections = 300; # That's it
  .probe = {
    #.url = "/"; # short easy way (GET /)
